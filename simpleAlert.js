angular.module('simpleAlert', [])
  .factory('simpleAlertFactory', ['$interval', '$sce', function ($interval, $sce) {
    var timeoutVar
    var internal = {
      messages: {},
  ...
  }]).directive('simpleAlert', ['$interval', 'simpleAlertFactory', '$sce', function ($interval, simpleAlertFactory, $sce) {
    return {
      restrict: 'E',
      scope: {
        id: '@'
      ...
      template: '<div data-ng-click="clickToClose()" ng-style="msg.message.length && {} || {display:\'none\'}" class="alert alert-{{msg.type}} alert-dismissable {{msg.defaultClasses}} {{msg.classes}}" ng-show="msg.message.length">' +
